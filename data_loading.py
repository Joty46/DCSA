...
class binary_class(Dataset):
        ...
        def __getitem__(self, idx):
            #print(self.path)
            image_path = os.path.join('/content/drive/MyDrive/DCSAU-Net_Lung/data/images/', self.folders[idx])
            mask_path = os.path.join('/content/drive/MyDrive/DCSAU-Net_Lung/data/masks/', self.folders[idx])
            image_id = self.folders[idx]
